...
import com.vithamastech.smartlight.interfaces.SelectedColorChangedEvent;
...
public class SpectrumPalette extends LinearLayout {
    ...
    private void init() {
        ...
        mColorItemDimension = getResources().getDimensionPixelSize(R.dimen._55sdp);
        mColorItemMargin = getResources().getDimensionPixelSize(R.dimen._5sdp);
    ...
    protected void createPaletteView() {
        ...
        for (int i = 0; i < mColors.length; i++) {
            colorItem = createColorItem(mColors[i], mSelectedColor);
...
//        GradientDrawable g = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{color,  //#fff this is the start color of gradient
//                adjustAlpha(color,0.7f),adjustAlpha(color,0.3f),adjustAlpha(color,0.1f)}); //#97712F this is the end color of gradient
//        g.setGradientType(GradientDrawable.RADIAL_GRADIENT); // making it circular gradient
//        g.setGradientRadius( getResources().getDimensionPixelSize(R.dimen._55sdp));  // radius of the circle
        GradientDrawable g = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{color,  //#fff this is the start color of gradient
                adjustAlpha(color,0.8f),adjustAlpha(color,0.6f),adjustAlpha(color,0.4f)}); //#97712F this is the end color of gradient
        g.setGradientType(GradientDrawable.LINEAR_GRADIENT); // making it circular gradient
//        g.setGradientRadius( getResources().getDimensionPixelSize(R.dimen._55sdp));  // radius of the circle
