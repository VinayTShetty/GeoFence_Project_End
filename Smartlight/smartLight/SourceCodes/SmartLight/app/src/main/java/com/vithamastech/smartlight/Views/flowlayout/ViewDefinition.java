package com.vithamastech.smartlight.Views.flowlayout;
...
public class ViewDefinition {
	...
	public int getLength() {
		return this.config.getOrientation() == CommonLogic.HORIZONTAL ? width
				: height;
	}
	...
	public int getSpacingLength() {
		return this.config.getOrientation() == CommonLogic.HORIZONTAL ? this.leftMargin
				+ this.rightMargin
				: this.topMargin + this.bottomMargin;
	}

	public int getThickness() {
		return this.config.getOrientation() == CommonLogic.HORIZONTAL ? height
				: width;
	}
	...
	public int getSpacingThickness() {
		return this.config.getOrientation() == CommonLogic.HORIZONTAL ? this.topMargin
				+ this.bottomMargin
	...
	public int getInlineX() {
		return this.config.getOrientation() == CommonLogic.HORIZONTAL ? this.inlineStartLength
				: this.inlineStartThickness;
	}

	public int getInlineY() {
		return this.config.getOrientation() == CommonLogic.HORIZONTAL ? this.inlineStartThickness
				: this.inlineStartLength;
	}
}
