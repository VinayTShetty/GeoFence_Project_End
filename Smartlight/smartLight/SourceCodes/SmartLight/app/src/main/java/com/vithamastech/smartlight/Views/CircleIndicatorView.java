...
/* For display rounded circle indicator. This view is used in app intro screen*/
public class CircleIndicatorView extends View {
    ...
    private void init(Context context) {
        ...
        activeIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.colorBlueTheme));
