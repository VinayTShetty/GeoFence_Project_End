...
import com.succorfish.eliteoperator.Vo.VoMessageHistory;
                ...
                if (mArrayListMessageHistory != null && mArrayListMessageHistory.size() > 0) {
                    mActivity.mUtility.errorDialogWithYesNoCallBack("Delete History", "Are you sure you want to delete history?", "YES", "NO", 1, new onAlertDialogCallBack() {
                        ...
                        public void PositiveMethod(DialogInterface dialog, int id) {
                            ...
                            mActivity.mUtility.errorDialogWithCallBack("All message deleted successfully", 0, false ,new onAlertDialogCallBack() {
                                @Override
                                public void PositiveMethod(DialogInterface dialog, int id) {
                                    isCalling = true;
                                    getDBMessageHistory();
        ...
        if (mStringSelectedMessageId == null || mStringSelectedMessageId.equalsIgnoreCase("")) {
            ...
            if (mActivity.isDevicesConnected) {
                ...
                if (isInsert != -1) {
                    ...
                    mActivity.mUtility.errorDialogWithCallBack("Message sent successfully", 0,false , new onAlertDialogCallBack() {
                        @Override
                        public void PositiveMethod(DialogInterface dialog, int id) {
                            isCalling = true;
                            getDBMessageHistory();
