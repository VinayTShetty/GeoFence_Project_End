...
public class VoServerInstallation implements Serializable {
    ...
    String port_id = "";
    String power = "";
    String device_install_location = "";
    String installation_county = "";
    String owner_name = "";
    ...
    String installer_mobile_no = "";
    String installer_email = "";
    String signaturepath = "";
    String pdfpath = "";
    String ins_sign_image = "";
...
// Succorfish Server
    ...
    public String getDevice_install_location() {
        return device_install_location;
    }

    public void setDevice_install_location(String device_install_location) {
        this.device_install_location = device_install_location;
    }

    public String getInstallation_county() {
        return installation_county;
    }

    public void setInstallation_county(String installation_county) {
        this.installation_county = installation_county;
    }
    ...
    public String getIns_sign_image() {
        return ins_sign_image;
    }

    public void setIns_sign_image(String ins_sign_image) {
        this.ins_sign_image = ins_sign_image;
    }

    public String getInstaller_mobile_no() {
        return installer_mobile_no;
    }

    public void setInstaller_mobile_no(String installer_mobile_no) {
        this.installer_mobile_no = installer_mobile_no;
    }

    public String getInstaller_email() {
        return installer_email;
    }

    public void setInstaller_email(String installer_email) {
        this.installer_email = installer_email;
    }
