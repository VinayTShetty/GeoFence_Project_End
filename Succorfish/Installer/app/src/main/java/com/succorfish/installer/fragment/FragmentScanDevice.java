...
public class FragmentScanDevice extends Fragment {
...
//        Call<VoAddInstallation> mLogin = mActivity.mApiService.checkScanInstallation(params, mActivity.mPreferenceHelper.getAccessToken());
...
//                            if (mVoAddInstallation.getMessage().equalsIgnoreCase("Device not found with this IMEI!")) {
//                                mActivity.mUtility.errorDialog("This IMEI code doesn't exist with us. Please check IMEI code.");
//                            } else if (mVoAddInstallation.getMessage().equalsIgnoreCase("New fresh device found successfully.")) {
//                                if (mVoAddInstallation.getData() != null) {
//                                    if (mOnBackWithInstallationData != null) {
//                                        VoAddInstallation mVoAddInstallationCallBack = new VoAddInstallation();
//                                        mVoAddInstallationCallBack.setData(new VoServerInstallation());
//                                        mVoAddInstallationCallBack.getData().setImei(mVoAddInstallation.getData().getImei());
//                                        mVoAddInstallationCallBack.getData().setDevice_type(mVoAddInstallation.getData().getDevice_type());
//                                        mVoAddInstallationCallBack.getData().setWarranty(mVoAddInstallation.getData().getWarranty());
//                                        mVoAddInstallationCallBack.getData().setImei(mVoAddInstallation.getData().getImei());
//                                        mVoAddInstallationCallBack.getData().setDate("");
//                                        mVoAddInstallationCallBack.getData().setLatitude("");
//                                        mVoAddInstallationCallBack.getData().setLongitude("");
//                                        mVoAddInstallationCallBack.getData().setServerDeviceId("");
//                                        mVoAddInstallationCallBack.getData().setAccountId("");
//                                        mOnBackWithInstallationData.onBackWithInstallData(mVoAddInstallationCallBack.getData());
//                                    }
//                                    mActivity.onBackPressed();
//                                }
//
...
//                                        builder.setTitle(getResources().getString(R.string.str_test_device));
//                                        builder.setCancelable(false);
//                                        builder.setMessage(String.format(getResources().getString(R.string.str_test_device_ready_to_use), imeiNo + ""));
//                                        builder.setPositiveButton(getResources().getString(R.string.str_test_device_view_last_record), new DialogInterface.OnClickListener() {
//                                            @Override
//                                            public void onClick(DialogInterface dialog, int which) {
////                                        dialog.dismiss();
