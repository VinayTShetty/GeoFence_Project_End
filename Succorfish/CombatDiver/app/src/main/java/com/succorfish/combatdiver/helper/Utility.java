...
import com.succorfish.combatdiver.views.ProgressHUD;
...
public class Utility {
    ...
    public void errorDialogWithCallBack(String message, int isSuccess, final onAlertDialogCallBack mCallBack) {
        if (mActivity != null) {
            if (mAlertDialogCallBack != null && mAlertDialogCallBack.isShowing()) {
                ...
                mAlertDialogCallBack.setCancelable(false);
