...
import com.succorfish.combatdiver.fragments.FragmentDashboard;
import com.succorfish.combatdiver.fragments.FragmentDeviceConnect;
import com.succorfish.combatdiver.fragments.FragmentDriverIoc;
import com.succorfish.combatdiver.fragments.FragmentMessage;
import com.succorfish.combatdiver.fragments.FragmentSetting;
import com.succorfish.combatdiver.helper.CustomDialog;
import com.succorfish.combatdiver.helper.Utility;
...
//        mToolbar.setNavigationIcon(R.drawable.ic_drawer_icon);
        ...
        if (isDevicesConnected) {
            mUtility.errorDialogWithYesNoCallBack("Delete History", "Are you sure you want to delete all history?", "YES", "NO", 1, new onAlertDialogCallBack() {
                ...
                public void PositiveMethod(DialogInterface dialog, int id) {
                    ...
                    mUtility.errorDialogWithCallBack("All history message deleted successfully", 0, new onAlertDialogCallBack() {
                        @Override
                        public void PositiveMethod(DialogInterface dialog, int id) {
    ...
    public void showDisconnectedDeviceAlert() {
        mUtility.errorDialogWithCallBack("Device is disconnected. Please connect and try again.", 1, new onAlertDialogCallBack() {
            @Override
            public void PositiveMethod(DialogInterface dialog, int id) {
                ...
                for (int i = 0; i < mDataHolder.get_Listholder().size(); i++) {
                    ...
                    if (isInsert != -1) {
                        ...
                        if (i == mDataHolder.get_Listholder().size() - 1) {
                            ...
                            mUtility.errorDialogWithCallBack("Message sent successfully", 0, new onAlertDialogCallBack() {
                                @Override
                                public void PositiveMethod(DialogInterface dialog, int id) {
...
//        intent.setComponent(new ComponentName("com.succorfish.locationreciver","com.succorfish.locationreciver.MyBroadcastReceiver"));
                                ...
                                if (mStringReceivedMsg != null && mStringReceivedMsg.length() >= 6) {
                                    ...
                                    if (mStrContactName != null && !mStrContactName.equals("")) {
                                        mUtility.errorDialogWithCallBack(contactId + ". " + mStrContactName, 0, new onAlertDialogCallBack() {
                                            @Override
                                            public void PositiveMethod(DialogInterface dialog, int id) {
                                ...
                                mUtility.errorDialogWithCallBack("Time set successfully", 0, new onAlertDialogCallBack() {
                                    @Override
                                    public void PositiveMethod(DialogInterface dialog, int id) {
                                ...
                                if (mStringReceivedMsg != null && mStringReceivedMsg.length() >= 6) {
                                    ...
                                    System.out.println("mStrContactName--" + mStrContactName);
                                    if (mStrContactName != null && !mStrContactName.equals("")) {
                                        mUtility.errorDialogWithCallBack("Modem sync with " + contactId + ". " + mStrContactName, 0, new onAlertDialogCallBack() {
                                            @Override
                                            public void PositiveMethod(DialogInterface dialog, int id) {
                                ...
                                if (mStringReceivedMsg != null && mStringReceivedMsg.length() >= 8) {
                                    ...
                                    if (mStrContactName != null && !mStrContactName.equals("") && mStrMsgName != null && !mStrMsgName.equals("")) {
                                        mUtility.errorDialogWithCallBack(mStrContactName + " Sent Message - " + mStrMsgName, 0, new onAlertDialogCallBack() {
                                            @Override
                                            public void PositiveMethod(DialogInterface dialog, int id) {
...
//        importDB();
    ...
    public void importDB() {
        ...
        String backupDBPath = "/data/com.succorfish.combatdiver/databases/EliteOperators.sqlite";
        String currentDBPath = "combatdiver.sqlite";
